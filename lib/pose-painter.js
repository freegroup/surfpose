...
class PosePainter {
    constructor(canvas, options = {}) {
        ...
        // Default options - read colors from CSS variables
        this.options = {
            // Colors from CSS variables
            lineColor: getCssVar('--accent', '#38bdf8'),
            pointColorGood: getCssVar('--success', '#22c55e'),
            pointColorWeak: getCssVar('--warning', '#f59e0b'),
            pointStrokeColor: getCssVar('--text-primary', '#fff'),
